...
Pros of context module functions:

- no need to be wrapped inside useCallbacks when defined inside Context Provider
  (and provided inside provider value)
- could be tree-shaken or lazily loaded
